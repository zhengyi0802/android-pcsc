...
#define PCSCLITE_FEATURES " Linux i686-pc-linux-gnu serial usb usbdropdir=" PCSCD_PATH "/usb ipcdir=/data/data/pcsc/ipc configdir=" PCSCD_PATH "/etc"
...
#define USE_IPCDIR "/data/data/pcsc/ipc"
